...
\section{Règles de décision}
	Premier modèle, division du spectre de pouvoir en deux: Comportement de haut pouvoir ou dominant, et comportement de bas pouvoir ou soumis
	Génération de règle de décision en fonction de l'acte de dialogue reçu.
