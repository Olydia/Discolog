...
%		 \begin{figure} [h]
%		 	\label{fig:StatePref1}
%		 	\centerline{\includegraphics[width=4.5in]{}}
%		 	\caption{}
%		 \end{figure} 
	...
	\begin{figure}[t]
		...
		\caption{Maximum de tours de \emph{StatePreference} autorisé en fonction des comportements de dominance de l'agent}
	\end{figure} 
