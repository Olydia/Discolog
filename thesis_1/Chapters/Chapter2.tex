...
%	Un aspect important dans la modélisation d'un agent négociateur est le module de communication qu'il utilise pour interagir avec son adversaire 
	...
	\subsection{Aspect social dans les modèles de négociations automatique}
	 ...
	 \subsection{Comportements de dominance chez les agents conversationnels}
		...
		Nous avons présenté dans cette section les contributions majeurs concernant la modélisation et la perception de la dominance. Cependant, la majorité de ces travaux se focalisent sur les comportements non verbaux. Peu de travaux encore s'intéressent à la modélisation de la relation interpersonnelle de la dominance entre un agent et un utilisateur et son expression à travers des comportements verbaux. 
		
		Dans cette thèse, nous visons à dépasser ces limites en nous intéressant plus particulièrement à la mise en place d'une relation interpersonnelle de dominance entre un agent et un utilisateur dans un contexte de négociation collaborative. Notre but est de proposer un agent négociateur capable d'adapter ses comportements de dominance pour complémenter ceux exprimés par son interlocuteur. En conséquence, l'agent adopte une stratégie de négociation précise qui prend en compte sa perception de la relation de dominance. 
