...
\begin{itemize}
	...
	\item \textbf{StatePreference(less',more')} : the agent reacts to the stated preference expressed by the user
		...
		\item \textbf{AskPreference(less, more)}:
...
\section{Reject(proposal)}
	...
	\begin{figure}[]
			...
			\vskip 8pt
			\defig{accept}{Tree of agent possible responses for a reject criterion input.}
	\end{figure}
...
\begin{figure}[]
		...
		\vskip 8pt
		\defig{accept}{Tree of agent possible responses for a reject option input.}
\end{figure}
