...
\end{figure}
	...
	\par The agent will analyses the value of the received utterance and depending on the perception of the relationship, the agent will choose  an adequate answer. The possibles responses are depicted in \fig{state}, and explained in the following: 
	\begin{enumerate}
