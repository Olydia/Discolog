...
%			 Focus space: les entités saillantes du dilaogue
		 ...
		 \subsection{Exemple d'analyse}
			 Nous présentons dans cette section un exemple de l'analyse en DSP que nous avons effectuée sur un dialogue préalablement enregistré. Le texte a été édité afin d'améliorer son intelligibilité en supprimant les pauses et des mots tels que "hmm, oué $\ldots$".
