...
%	
	...
	\begin{minipage}{.99\textwidth}
		{\ttfamily
			...
			\vspace{0.5em}
				\textbf{A:} $Propose(Chinese)$ "Let's go to a Chinese restaurant."
				
				 \hspace*{3mm} \textbf{B:} $AskPreference(Ambiance)$  "What kind of ambiance do you like?"
				
				\textbf{A:} $StatePreference(family,true)$ "I like family restaurants."
				
				\hspace*{3mm} 	\textbf{B:}  $StatePreference(family,false)$ "I don't like family restaurants."
				
				\textbf{A:}  $Propose(family)$ "Let's go to a family restaurant."
				
				\hspace*{3mm} 	\textbf{B:} $Reject(family)$ "Sorry, I'd rather choose something else, because I don't like family restaurants."
				
				\textbf{A:}  $Propose(family)$ "Let's go to a family restaurant."
				
				\hspace*{3mm} 	\textbf{B:} $AskPreference(Cost)$ "What kind of cost do you like?"
				
				\textbf{A:} $StatePreference(cheap,true)$ "I like cheap restaurants."
				
				\hspace*{3mm} 	\textbf{B:} $Propose(cheap)$ "Let's go to a cheap restaurant."
				
				\textbf{A:}  $Propose(Jiliya)$ "Let's go to the Jiliya. It's a quiet, cheap Chinese restaurant."
				
				\hspace*{3mm} 	\textbf{B:} $Accept(Jiliya)$  "Okay. Let's go to the Jiliya."
