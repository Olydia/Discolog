	...
	\begin{minipage}{\textwidth}
			{\ttfamily
				\begin{addmargin}[1em]{2em}% 1em left, 2em right
					...
					14. \hspace*{3mm}\textbf{B}: $Accept(expensive)$ "Okay, let's go to an\hspace*{4mm} expensive restaurant."
					
					
					15. \textbf{A}: $Propose(Juji)$ "Let's go to the Juji restaurant. \hspace*{3mm} It's a cozy, expensive Japanese restaurant near\hspace*{3mm}  eiffel tower."
