	...
	Therefore, the acceptability of a value $v$ is relative to the weight an agent gives to its self satisfaction. We note 
	...
	$$tolerable(dom, t, o, \prec, A, U) = \frac{ \sum_{i}^{n} acc(dom, t, o_i, \prec_i, A_i, U_i) } {n}$$ 
	...
	\begin{tabular}{|p{3cm}|p{9cm}|}
		...
		\hline
		Reject & $\exists c \in Op_i$, $sat(o, \prec) < \beta$  \emph{OR}   $ \exists o \in Op_o$ ,  $sat(c, \prec_i) < \beta$ \newline  \emph{AND} $t<\tau$.\\
		\hline
