...
%Toutefois, ces dialogues nous ont permis d’observer des  comportements intéressants à notre recherche. 

\begin{enumerate}
	\item Structure linguistique %-> Structure de la tâche de trouver un restaurant
	\item Structure intentionnelle %-> comportement social dans la conversation 
