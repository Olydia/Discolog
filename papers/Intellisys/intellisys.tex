...
%	\usepackage[caption=false,font=footnotesize]{subfig}
	...
	We present in this paper a computational model of collaborative negotiation capable of simulating an interpersonal relationship of dominance between two negotiator agents.
	Our simulation is based on a previously published model. We present a model based on Theory of Mind that allows an agent to evaluate its interlocutor's level of power at each negotiation turn. We show on agent-agent simulation that the system correctly predicts the interlocutor's power. 
	\end{abstract}
