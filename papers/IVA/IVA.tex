		...
		%					\begin{figure}[h]
		%						\centering
		%						\caption{\label{considerOther} The results fork the  hypothesis H1}
		%						\includegraphics[width=3in]{graphs/H1}
		%					\end{figure}
		%					
							
		%		\begin{figure}[!htb]\centering
		%			\begin{minipage}{0.49\textwidth}
		%				\frame{\includegraphics[width=\linewidth,natwidth=610,natheight=642]{graphs/H1}}
		%				\caption{The results for the  hypothesis H1}\label{considerOther}
		%			\end{minipage}
		%			\begin {minipage}{0.49\textwidth}
		%			\frame{\includegraphics[width=\linewidth,natwidth=610,natheight=642]{graphs/H2}}
		...
		%	\end{figure}
				...
				\begin{figure}
					\begin{floatrow}
						\ffigbox{%
							\includegraphics[width=0.49\textwidth]{graphs/H1}
						}{%
						\caption{A figure}%
					}
					\capbtabbox{%
