	...
	\begin{document}
		...
		1. Agents more and more popular
		2. Different roles (exemples)
		3. Situation of collaboration
		4. Exemple (tuteur)
		5. Depending on individual goals, expertise etc, need to negotiate
		6. Specific type of nego: collab nego
		
		With the rise in popularity of artificial conversational agents playing different roles, from XX to XX, they have become capable of holding closer interaction with a human user.  By close, we mean that
		...
		In many situations, the user and the agent typically negotiate in a collaborative manner about the way to achieve the shared goal.
