	...
	\begin{document}
		...
		With the rise in popularity of artificial conversational agents playing different roles, they have become capable of holding closer interaction with a human user.  By close, we mean that
		 agents share commaons goals, beliefs and tasks. In order to achieve their common goals, agent and user have to collaborate through their interaction.
		...
		In this paper, we present a conversational agent that aims to contribute to essentials aspects of HRI.
