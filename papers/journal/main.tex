...
\subsection{Collaboration implies negotiation}
	...
	%Collaboration in multi-agent systems is defined as a form of interaction that focuses on the distribution of work among several agents, whether centralized or distributed techniques \cite{ferber1997systemes}. Cooperation remains the prerogative to be able to engage in an explicit common project \cite{lucien2016multiagent}.
