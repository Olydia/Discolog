...
public enum Restaurant implements Option {
	...
	AYÇA(Cuisine.TURKISH, Cost.EXPENSIVE, Atmosphere.LIVELY, Location.DOWNTOWN),
	...
	SAÏGON(Cuisine.CHINESE, Cost.CHEAP, Atmosphere.QUIET, Location.WEST_SIDE),
	...
	SAIGON(Cuisine.CHINESE, Cost.AFFORDABLE, Atmosphere.QUIET, Location.WEST_SIDE),
	...
	SHANGAÏ_PALACE(Cuisine.CHINESE, Cost.AFFORDABLE, Atmosphere.ROMANTIC, Location.EAST_SIDE),
	...
	HOLLYWOOD_CAFÉ(Cuisine.MEXICAN, Cost.CHEAP, Atmosphere.QUIET, Location.DOWNTOWN),
